...
function Login() {
    ...
    const handleSubmit = (event) => {
        ...
        mockAuthService(username, password)
            ...
            .then((response) => {
                navigate('/main');
                // alert(`خوش آمدید ${response.token}`);
            })
                ...
                <Col className='formClass'>
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3 rememberTitle" controlId="formBasicCheckbox">
                            ...
                            <a href='./passwordForgotten' class="link">فراموشی رمز عبور</a>
                        ...
                        {/* <p className='signUp-title'>حساب کاربری ندارید؟ ثبت نام کنید</p> */}

                        <p class="signUp-title">حساب کاربری ندارید ؟ <a href="/Authentication/Signup" class="link">ثبت نام </a>کنید</p>
